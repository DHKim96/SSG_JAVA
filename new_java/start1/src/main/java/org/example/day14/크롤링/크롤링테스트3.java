...
public class 크롤링테스트3 {
    ...
    public static void crawling(String name, String num) throws IOException {
        Document doc2 = Jsoup.connect("https://finance.naver.com/item/main.naver?code=" + num).get();
